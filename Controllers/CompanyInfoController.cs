...
namespace LegacyTest.Controllers
{
    ...
    public class CompanyInfoController : Controller
    {
        ...
        public CompanyInfoController(LegacyDBContext context, IConfiguration configuration)
        {
        ...
        public IActionResult Plans()
        {
            ...
            ViewBag.Key = _configuration["EpaycoSettings:EpaycoKey"];
